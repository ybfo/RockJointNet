...
def draw() -> None:
    ...
    for path in (
        OUT / "framework_clean_matched.png",
        OUT / "framework_clean_matched.pdf",
        MANUSCRIPT_FIGURES / "framework_clean_matched.png",
        MANUSCRIPT_FIGURES / "framework_clean_matched.pdf",
    ):
